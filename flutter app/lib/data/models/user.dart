...
class User extends Equatable {
  ...
  final bool
      receiveNotifications; // true to receive notifications when card is collected
  ...
  factory User.fromMap(Map<String, dynamic> map) {
    return User(
      ...
      receiveNotifications: (map['receiveNotifications'] as int?) == 1,
  ...
  factory User.fromJson(Map<String, dynamic> json) {
    ...
    return User(
      ...
      receiveNotifications:
          preferences?['receiveNotifications'] as bool? ?? true,
    );
  }
